...
class Boat(BaseGObject):
    def __init__(self, x, y):
        ...
        animated = [
            {'path': 'media/boat/boat_0.png', 'duration': 300},
            {'path': 'media/boat/boat_swing_r_1.png', 'duration': 300},
            {'path': 'media/boat/boat_swing_r_2.png', 'duration': 300},
            {'path': 'media/boat/boat_swing_r_3.png', 'duration': 300},
            {'path': 'media/boat/boat_swing_r_2.png', 'duration': 300},
            {'path': 'media/boat/boat_swing_r_1.png', 'duration': 300},
            {'path': 'media/boat/boat_0.png', 'duration': 300},
            {'path': 'media/boat/boat_swing_l_1.png', 'duration': 300},
            {'path': 'media/boat/boat_swing_l_2.png', 'duration': 300},
            {'path': 'media/boat/boat_swing_l_3.png', 'duration': 300},
            {'path': 'media/boat/boat_swing_l_2.png', 'duration': 300},
            {'path': 'media/boat/boat_swing_l_1.png', 'duration': 300},
        ]
